...
TOKEN = '8175246820:AAHIq7q4nGJxbvVnZVZyFM1g5q8eZ1zU-6I'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002281091596
CHANNEL_ID = -1002281091596
error_channel_id = -1002281091596
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*CONTACT OWNER @LUSHOwner*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*OWNER @VIKAS_YADAV29*", parse_mode='Markdown')
    else:
